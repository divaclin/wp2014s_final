		...
		for(var i=0; i<id_array.length; i++){
			...
			query.find({
  				success: function(results) {
    				...
    				var string = '<div class="issue-block style="width:'+window.screen.width/5+'px;"><div class="issue-content"><p>' + title + '</p><img src="' + pic_url +'" class="issue-img" /><span>' + issue_date + '</span></div><span><a href="#">我要連署</a><a href="' + petition_url + '">連署聲明</a></span></div></div>';
