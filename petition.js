...
function petition(object_id){
	...
	query.find({
  		success: function(results) {
    		...
    		var Comments_Str = '<div id="Comments"><form action="" method="POST"><h3 id="comment-title">我有話要說</h3><h4><textarea name="comments" rows="10" cols="50"></textarea></h4><h4><input name="submit" type="submit" value="提 交" /></h4></form></div><div id="pen"><img src="img/hand.png" /></div><div id="bottom-line"></div>';
