$().ready(function(){
	...
	$("article section").append('<ul id="index_ul" style="left:'+ul_fixed+'px;"><img src="img/listyle.png"><li><a>關於我們</a></li><img src="img/listyle.png"><li><a href="catagory.html">查看連署</a></li><img src="img/listyle.png">	<li id="if-not-logged-in"><a href="#" id="login-btn">登入/註冊</a></li><li id="if-logged-in" style="display:none"><a href="#" id="logout-btn">登出</a></li></li><img src="img/listyle.png"><li><a>搜尋連署</a></li></ul>');
